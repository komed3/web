...
export function Intro () {
    return ( <section className="relative min-h-screen w-full flex flex-col lg:flex-row overflow-hidden max-w-full">
        ...
        <div className="relative z-10 flex-1 min-w-0 flex flex-col justify-center p-6 sm:p-10 lg:p-12 bg-white lg:brutal-border lg:border-y-0 lg:border-l-0 overflow-hidden max-w-full">
            <Background />
